<template>
    <div>
        <div v-if="$page.props.flash.success !== null && show" class="flex items-center justify-between mb-2 w-full bg-green-500 rounded">
        ...
        <div v-if="($page.props.flash.error !== null || Object.keys($page.props.errors).length > 0) && show" class="flex items-center justify-between mb-8 max-w-3xl bg-red-500 rounded">
            <div class="flex items-center">
